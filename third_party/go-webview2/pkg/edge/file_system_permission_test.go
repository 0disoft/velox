...
func TestFileSystemPermissionKeepsBrowserConsentAndDefaultDenials(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "no-gesture", kind: 8, origin: trusted, want: CoreWebView2PermissionStateDeny},
		{name: "invalid-gesture", kind: 8, origin: trusted, gesture: 2, want: CoreWebView2PermissionStateDeny},
		{name: "kind-read-failed", kind: 8, origin: trusted, gesture: 1, kindResult: failed, want: CoreWebView2PermissionStateDeny},
		{name: "gesture-read-failed", kind: 8, origin: trusted, gesture: 1, gestureResult: failed, want: CoreWebView2PermissionStateDeny},
