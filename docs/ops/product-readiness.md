...
| Windows lifecycle | Bounded shutdown, immediate relaunch, initialization cancellation, no residual process/profile lock; bind runtime and source/artifact versions | Public alpha.61 passed 10 local fresh/immediate pairs with observed browser exit and profile release; six tag-matching source cancellation cases passed separately. Public-EXE cancellation and hosted alpha.61 stress remain unverified; see [alpha.61 lifecycle](alpha61-lifecycle.md) |
