...
| File Notes behavior | Real open, edit, save, save-as cancellation, permission denial, close/reopen and draft recovery using disposable files | API-double regressions pass; real picker and persistence checks remain unverified |
