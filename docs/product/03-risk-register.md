...
| R-007 | Hosted-runner noise produces false performance claims | High | High | Open | Pin environments, publish raw failures, use repeated p50 and p95, and avoid claims below the noise threshold |
