...
| R-013 | A downloaded release bundle is tampered with | Low | Critical | Monitoring | Public verifier run 34585168947 downloaded current preview `v0.5.10-alpha.51` without checkout and matched independently recorded ZIP SHA-256 `a2beb179266861be018fea9366eb6be201ede502515a97f0fcacb964ad0dc72a` from publication producer run 34584828937 before exercising it. ADR 0011 does not pretend co-located checksums authenticate a compromised release channel; retain the unsigned-channel limitation and revisit authenticated attestations for a broader channel |
