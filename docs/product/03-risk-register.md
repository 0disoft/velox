...
| R-011 | Working name conflicts with existing products or namespaces | High | High | Mitigating | The collision review found Meta Velox plus a released Go CLI that already ships `velox.exe`; ADR 0013 blocks public executable publication until a replacement product and command identity is selected and synchronized |
